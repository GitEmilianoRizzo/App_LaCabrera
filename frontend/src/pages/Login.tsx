    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-background via-background to-muted/50 p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold tracking-tight">LA CABRERA</h1>
          <p className="text-muted-foreground mt-1">Central de Información para Franquicias</p>
        </div>
        ...
        <p className="text-center text-sm text-muted-foreground mt-6">
          &copy; {new Date().getFullYear()} LA CABRERA. Todos los derechos reservados.
        </p>
      </div>
    </div>
  )
